...
function DetailAccount(props) {
    ...
    const [updateinfo, setUpdateInfo] = useState({
         fullname: !props.user ? "" : props.user.user_data.fullname,
        mail: '',
        dni: '',
        birth: '',
        ubicacion:'',
    ...
    return (
                ...
                <div>
                    <div >
                        ...
                        <form onSubmit={(e) => handleSubmit(e)}>
                            ...
                            <input className='' type="text" onChange={handleInputChange} placeholder={props.user.user_data.fullname}
                                value={updateinfo.fullname} name="fullname" />
                            <div ><p>E-mail:</p>
                                {/* <p>{props.user.account_data.mail}</p> */}
                            </div>
                            <input className='' type="text" onChange={handleInputChange} placeholder={props.user.account_data.mail}
                            ...
                            <input className='' type="text" onChange={handleInputChange} placeholder={props.user.user_data.dni}
        ...
        <input
          ref={textAreaRef}
          value={props.user.account_data.cvu}
        />
      </form>
                    {
       ...
       document.queryCommandSupported('copy') &&
        <div>
          ...
          {copySuccess}
                            ...
                            <input htmlFor="birthdate" className='' type="date" placeholder={props.user.user_data.birth} data-date-split-input="true" name='birth' value={updateinfo.birth} onChange={handleInputChange}  min="1900-01-01" max="2003-12-31" />
                            <div ><p>Address:</p>
                            {/* <p>{props.user.user_data.ubicacion}</p> */}
                            </div>
                            <input className='' type="text" onChange={handleInputChange} placeholder={props.user.user_data.ubicacion}
