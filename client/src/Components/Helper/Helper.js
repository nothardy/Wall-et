...
export default function Helper() {
  ...
  let actions = RegExp("(CHANGE|FORGOT|RESET|RECOVER|RETRIEVE|REGAIN|RECLAIM|RECOUP|RECUPERATE|GETBACK|GET BACK|MAKEUP|MAKE UP|ADD|DELETE)");
  ...
  const defaultText= <p> I don't understand what you say. 
    ...
    Or fill in the solicited information <a href="/help/form">here</a> so that <br/>
    a human customer service representative can contact you</p>
  ...
  return (
    <div className={s.container}>
      ...
      <hr/>
      <p> To have a human customer service representative contact you,<a href="/help/form">click here </a></p>
    </div>
  );
}