...
const CardTransfer = () => {
	...
	const toggleShow = () => {
		setSecurityLayer({ ...securityLayer, show: !securityLayer.show });
	};
		...
		<div className={cf.container}>
			{!securityLayer.toglePassSecurity ? (
				<form onSubmit={(e) => handleSubmitSecurity(e)}>
					...
					<button className={cf.buttonsend} type="submit">
						Send
					</button>
				</form>
			) : (
				<form
					className={cf.formSecurity}
				...
				>
					...
					<div className={cf.containerInputAndIcon}>
						<input
							type={!securityLayer.show ? "password" : "text"}
							className={cf.inputKey}
							name="key"
					...
					<button className={cf.btnSubmitKey} type="submit">
						Send
					</button>
				</form>
			)}
