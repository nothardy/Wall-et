...
const Transfer = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    if (info.data.length < 1) return await swal("error!", "incomplete field!", "error");
          ...
          {!store.dataByCBU ? (
            <div className={t.containerCVU}>
              ...
              <form onSubmit={(e) => handleSubmit(e)}>
                <input type="text" name="data" id={t.input__codeCVU} value={info.data} onChange={(e) => handleChange(e)} />
