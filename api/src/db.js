...
Account.belongsToMany(Account, { as: 'user', foreignKey: 'userId', through: 'contacts' })
Account.belongsToMany(Account, { as: 'contact', foreignKey: 'contactId', through: 'contacts' })
